...
import com.example.seoulapp.ui.dashboard.Comment;
import com.example.seoulapp.ui.dashboard.ReviewAdapter;
import com.example.seoulapp.ui.dashboard.ReviewItem;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {//index, 우리가 보낸 view, view 그룹
                ...
                input_cmt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //cmt에 담길 시간이 필요한가
                        ...
                        if (strCmt.equals("")) { //
                            ...
                            new MyReviewAdapter.JSONTaskStoreComment().execute("http://dongdong.com.ngrok.io/StoreComment");
                        }
                    }
                });
            }
        ...
        ReviewImg.setOnClickListener(new View.OnClickListener() { //하트 애니메이션
            ...
            public void onClick(View v) { //db에 좋아요(like) 컬럼 추가
                ...
                new MyReviewAdapter.JSONTaskaddLike().execute("http://dongdong.com.ngrok.io/addLike");
