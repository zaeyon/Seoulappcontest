...
public class ShopDetaildInfo extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONTaskProduction().execute("http://c0289aff.ngrok.io/getShopProduction");
        new JSONTaskQnA().execute("http://c0289aff.ngrok.io/getQnAInfo");
        // 선언한 변수에 생성한 레이아웃 설정
        ...
        production_btn.setVisibility(View.INVISIBLE);
        ...
        QNA_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                QNA_btn.setVisibility(View.INVISIBLE);
                production_btn.setVisibility(View.VISIBLE);
        ...
        production_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                QNA_btn.setVisibility(View.VISIBLE);
                production_btn.setVisibility(View.INVISIBLE);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("")) {
                ...
                for (int i = 0; i < QnA.length; i++) {
                    QnAInfo = QnA[i].split("\\|");
                    adapter.addItem(QnAInfo[3], QnAInfo[4], QnAInfo[5]);
                }
