    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nicknameData.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean hasFocus) {
                if (!hasFocus) {
                    // 와이파이 새로 접속할 때마다 변경
                    new JSONTask().execute("http://dongdong.com.ngrok.io/nickname");
        ...
        emailData.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean hasFocus) {
                if (!hasFocus) {
                   ...
                   new JSONTask().execute("http://dongdong.com.ngrok.io/email");
...
//버튼이 클릭되면 여기 리스너로 옴
        signupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new JSONTask().execute("http://dongdong.com.ngrok.io/post");
